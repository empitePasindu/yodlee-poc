# swagger_client.ProviderAccountsApi
...
api_instance = swagger_client.ProviderAccountsApi()
...
provider_account_request = swagger_client.ProviderAccountRequest() # ProviderAccountRequest | loginForm or field entity (optional)
...
# create an instance of the API class
api_instance = swagger_client.ProviderAccountsApi()
provider_account_request = swagger_client.ProviderAccountRequest() # ProviderAccountRequest | loginForm or field entity
...
# create an instance of the API class
api_instance = swagger_client.ProviderAccountsApi()
preferences = swagger_client.ProviderAccountPreferencesRequest() # ProviderAccountPreferencesRequest | preferences
provider_account_id = 789 # int | providerAccountId
