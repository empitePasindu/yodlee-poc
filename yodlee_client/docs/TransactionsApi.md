...
# create an instance of the API class
api_instance = swagger_client.TransactionsApi()
transaction_category_request = swagger_client.TransactionCategoryRequest() # TransactionCategoryRequest | User Transaction Category in JSON format
...
transaction_request = swagger_client.TransactionRequest() # TransactionRequest | transactionRequest
...
api_instance = swagger_client.TransactionsApi()
rule_id = 789 # int | ruleId
transaction_categories_rule_request = swagger_client.TransactionCategorizationRuleRequest() # TransactionCategorizationRuleRequest | transactionCategoriesRuleRequest
...
# create an instance of the API class
api_instance = swagger_client.TransactionsApi()
update_category_request = swagger_client.UpdateCategoryRequest() # UpdateCategoryRequest | updateCategoryRequest
