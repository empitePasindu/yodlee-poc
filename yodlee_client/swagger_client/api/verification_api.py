...
class VerificationApi(object):
    ...
    def get_verified_accounts(self, provider_account_id, **kwargs):  # noqa: E501
        ...
        The Verified Accounts API v1.1 provides information of bank and investment accounts that are verified by the user and applies only to Instant Account Verification (IAV) customers using FastLink 4.0. By default, the API only returns successfully verified accounts's information. <br><br>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str is_selected: Comma separated isSelected. Allowed values are true, false
        :param str verification_status: Comma separated verificationStatus. Allowed values are SUCCESS, FAILED
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_verified_accounts_with_http_info(provider_account_id, **kwargs)  # noqa: E501
            return data
    ...
    def get_verified_accounts_with_http_info(self, provider_account_id, **kwargs):  # noqa: E501
        ...
        all_params = ['provider_account_id', 'account_id', 'is_selected', 'verification_status']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('provider_account_id' not in params or
            ...
            raise ValueError("Missing the required parameter `provider_account_id` when calling `get_verified_accounts`")  # noqa: E501
        ...
        if 'is_selected' in params:
            query_params.append(('isSelected', params['is_selected']))  # noqa: E501
        if 'provider_account_id' in params:
            query_params.append(('providerAccountId', params['provider_account_id']))  # noqa: E501
        if 'verification_status' in params:
            query_params.append(('verificationStatus', params['verification_status']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='VerifiedAccountResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
